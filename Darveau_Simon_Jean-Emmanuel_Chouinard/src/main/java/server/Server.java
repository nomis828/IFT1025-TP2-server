...
public class Server {
    ...
    public void handleLoadCourses(String arg) {
        ...
        try {
            FileReader fr = new FileReader("./src/main/java/server/data/cours.txt"); // ./src/main/java/server/
    ...
    public void handleRegistration() {
        try {
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("./src/main/java/server/data/inscription.txt", true)); // ./src/main/java/server
